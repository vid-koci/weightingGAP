#!/usr/bin/python
#
# Copyright 2018 Google LLC, 2020 University of Oxford InfoLab
#
...
def read_annotations(filename, is_gold, id_list=None):
...
def calculate_scores(gold_annotations, system_annotations, weights_path):
...
def run_scorer(gold_tsv, system_tsv, weights):
    """Run the scorer.
...
if __name__ == '__main__':
    ...
    parser.add_argument(
            ...
            dest='weights',
            required=True,
            help='Path to the json file with a list of weights. Used to compute the re-balanced score.')
